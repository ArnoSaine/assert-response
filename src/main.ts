 ...
 * @throws {Response} - A `Response` object with status `412 Precondition Failed` and the given body/init.
 */
export const preconditionSuccessful: HttpResponseAssertion = negate(preconditionFailed);
export { preconditionSuccessful as preconditionMet, preconditionSuccessful as preconditionPassed };
